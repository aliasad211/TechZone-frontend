    ...
    <div style={styles.container}>
      ...
      <div style={styles.layout}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <button onClick={() => { clearCart(); toast.success('Cart cleared!'); }} style={styles.clearBtn}>Clear Cart</button>
        </div>
        ...
        <div style={styles.summary}>
          ...
          {cartTotal < 5000 && <p style={styles.freeShip}>Add Rs. {(5000 - cartTotal).toLocaleString()} more — Get free shipping!</p>}
