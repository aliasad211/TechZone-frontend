      ...
      <div style={styles.mainGrid}>
        ...
        <div style={styles.infoSection}>
          ...
          <div style={styles.features}>
            <div style={styles.feature}><span>🚚</span><span>FREE Delivery on orders above Rs. 5,000</span></div>
            <div style={styles.feature}><span>🔄</span><span>7-day return policy</span></div>
              ...
              <div style={styles.reviewForm}>
                ...
                <form onSubmit={handleReviewSubmit}>
                  ...
                  <div style={styles.field}>
                    ...
                    <textarea style={{ ...styles.input, height: '90px', resize: 'vertical' }} value={reviewForm.comment} onChange={e => setReviewForm(p => ({ ...p, comment: e.target.value }))} required placeholder="Share your experience..." />
                  </div>
