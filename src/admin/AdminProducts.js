            ...
            <tbody>
              {products.map((p) => (
                <tr key={p._id} style={{ background: '#fff' }}>
                  ...
                  <td style={{ ...styles.td, fontWeight: '700' }}>Rs. {p.price?.toLocaleString()}</td>
                  <td style={styles.td}>
...
const styles = {
  ...
  addBtn: { background: '#1e293b', color: '#fff', padding: '10px 20px', borderRadius: '8px', textDecoration: 'none', fontWeight: '600', fontSize: '14px', transition: 'background-color 0.2s' },
  ...
  prodImg: { width: '50px', height: '50px', objectFit: 'contain', borderRadius: '6px', background: '#f8fafc' },
  editBtn: { background: '#f1f5f9', color: '#334155', padding: '5px 12px', borderRadius: '6px', textDecoration: 'none', fontSize: '12px', fontWeight: '600' },
  deleteBtn: { background: '#f1f5f9', color: '#b91c1c', border: 'none', padding: '5px 12px', borderRadius: '6px', cursor: 'pointer', fontSize: '12px', fontWeight: '600' },
